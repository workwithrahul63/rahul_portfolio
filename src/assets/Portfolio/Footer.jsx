      ...
      <div className="max-w-7xl mx-auto flex flex-col space-y-12">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-8 pb-12 border-b border-white/10">
          <div className="space-y-2">
            <div className="flex items-center gap-2 drop-shadow-[0_2px_15px_rgba(220,38,38,0.5)]">
              <img src={logoImg} alt="Rahul Macwan Logo" className="h-7 w-auto brightness-0 invert" />
              <span className="text-xl font-black text-white tracking-tighter">RAHUL</span>
            </div>
